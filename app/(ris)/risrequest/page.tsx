...
export default function Page() {
  ...
  const handleSubmitCode = async () => {
    ...
    if (code && data.length > 0) {
      ...
      setSelectedItem(null)
      setErrorMessage('This code does not exist or inactive')
    }
  }
  ...
  return (
    <>
      <div className="app__landingpage">
        ...
        <div className="mt-12 mb-20 flex flex-col space-y-6 items-center">
          {successMessage === '' && (
          ...
          {!selectedItem && successMessage === '' && (
            <div className="w-[440px] p-1 border flex flex-col space-y-4">
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="p-4 w-full outline-none text-xl text-gray-700 font-medium"
                  />
                  {code !== '' && (
                    <CustomButton
          ...
          {selectedItem && (
            <div className="w-4/5 md:w-1/2 p-4 border flex flex-col space-y-4">
